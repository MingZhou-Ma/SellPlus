package tech.greatinfo.sellplus.utils.encode;
...
/**
* @Package：com.wanguo.wx.core.utils.encode   
* @ClassName：EncodeUtils   
* @Description：   <p> 集成Commons-Codec,Commons-Lang及JDK提供的编解码方法. </p>
* @Author： - Jason   
* @CreatTime：2018年7月25日 上午9:54:48   
* @Modify By：   
* @ModifyTime：  2018年7月25日
* @Modify marker：   
* @version    V1.0
 */
public class EncodeUtils {
	...
	public static byte[] decodeHex(String input) {
		try {
			...
			throw new IllegalStateException("[WANGUO-ERROR]Hex Decoder exception", e);
		}
	}
	...
	public static void main(String[] args) {
		System.out.println("wubin@wanguo.com".getBytes());
		System.out.println(encodeBase64("wubin@wanguo.com".getBytes()));
	}
