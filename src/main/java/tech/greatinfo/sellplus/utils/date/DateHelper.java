 ...
 * </html>
 */
package tech.greatinfo.sellplus.utils.date;
...
* @Author： - Jason   
* @CreatTime：2018年8月20日 下午4:45:40   
* @Modify By：   
...
public class DateHelper {
	 ...
	 * @return String 获取当前时间，格式为：yyyy-MM-dd HH:mm:ss
	 * @Autor: Jason
	 */
	...
	/**
	 * @Description: 获取当前yyyyMMddHHmmss
	 * @return String
	 * @Autor: Jason
	 */
	...
	/**
	 * @Description: 获取当前yyyyMMddHHmm
	 * @return String
	 * @Autor: Jason
	 */
	public static String getCurrentYMDHM(){
		return getCurrentTime(DateFormatUtils.TIME_YMDHM_FORMAT);
	}
	
	
	/**
	 * @Description: 获取指定格式的当前时间：为空时格式为yyyy-mm-dd HH:mm:ss
	 * @param format   指定的格式  默认的格式为：yyyy-mm-dd HH:mm:ss
	 * @return Date    获取指定格式的当前时间
	 * @Autor: Jason
	 */
