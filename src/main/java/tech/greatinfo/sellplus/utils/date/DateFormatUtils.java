...
* @Author： - Jason   
* @CreatTime：2018年8月20日 下午4:46:36   
* @Modify By：   
...
public class DateFormatUtils {
	...
	/** yyyyMMddHHmm */
	public static final String TIME_YMDHM_FORMAT = "yyyyMMddHHmm";
	...
	public static String formatDate(Date date,String format){
		return formatDate(DateHelper.date2String(date), format);
	}
	...
	public static String formatDate(String value){
		return getFormat(DATE_FORMAT2).format(DateHelper.string2Date(value, DATE_FORMAT2));
	}
	...
	public static String formatDate(Date value){
		return formatDate(DateHelper.date2String(value));
	}
